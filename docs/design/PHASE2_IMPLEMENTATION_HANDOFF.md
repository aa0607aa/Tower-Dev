...
> **상태: APPROVED DESIGN / PHASE 2 착수 가능**
>
> 오너 최종 승인: 2026-08-18
> 구현 담당 Claude는 이 문서와 `DECISIONS.md D-016/D-017`을 기준으로 PHASE 2 티켓을 구현한다.
...
- 1층 실제 최종 크기/방 개수 — greybox PLAYTEST로 조정 가능한 DESIGN

---

## 5. Claude 작업 시작 조건

**D-016 설계 차단은 해제됐다. PHASE 2 착수 가능.**

착수 전에:
1. `COLLABORATION_PROTOCOL.md`
2. `docs/log/2026-08.md`
3. `DECISIONS.md D-016/D-017`
4. `docs/canon/FLR.md` (`FLR-001/002/017/023~027`)
